...
public class EjemploProperties_DialogoConfiguracion extends JDialog {
	 ...
	 */
	public EjemploProperties_DialogoConfiguracion( String nomFic, String[] props, String[] mensajes, String[] defecto, String[] tipos ) throws IndexOutOfBoundsException {
	...
	private class BotonCambiarPath implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			int valor = fc.showDialog( EjemploProperties_DialogoConfiguracion.this, mens );
	...
	public static void main(String[] args) {
		...
		try {
			EjemploProperties_DialogoConfiguracion dialog = new EjemploProperties_DialogoConfiguracion( "prueba.prop.xml", props, mensajes, defecto, carpetas );
